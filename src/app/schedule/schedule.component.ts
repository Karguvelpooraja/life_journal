...
export class ScheduleComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    this.events = [
      { name: 'Placing  ceremonial auspicious pole for wedding', date: 'Nov 22, 2025', time: '7:30 PM - 8:30 PM ', location: 'Both Houses', description: 'Beginning of wedding celebrations in both families.' },
